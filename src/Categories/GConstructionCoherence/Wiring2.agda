...
-- Segment obligation ob2 (see Wiring.agda).  Performance-critical call
...
module Categories.GConstructionCoherence.Wiring2 where
...
private
  iso₂ : ⟪ R₂ᵗ ⟫ ≅ᴴ ⟪ L₂ᵗ ∘ ρ₂ᵗ ⟫
  iso₂ = force! (findIsoᵀ ⟪ R₂ᵗ ⟫ ⟪ L₂ᵗ ∘ ρ₂ᵗ ⟫) refl
