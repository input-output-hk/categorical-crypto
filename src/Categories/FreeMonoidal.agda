...
-- `Go` (used to 'define' `⟦_⟧₀` in the middle of `FreeFunctorData`, where a
-- bare definition is not allowed) is now just the generator-independent
-- `FreeObjInterp` re-exported at this `d`.
