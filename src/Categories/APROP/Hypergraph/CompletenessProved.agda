...
--
-- The original CompletenessProved.agda contained the constructive proofs of:
--
...
module Categories.APROP.Hypergraph.CompletenessProved (sig : APROPSignature) where
...
-- `CompletenessAxioms.agda` so that `CompletenessProved.agda` is fully
