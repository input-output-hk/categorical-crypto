...
--------------------------------------------------------------------------------
-- Lemma 0 of the soundness proof: "vertex relabelling is free + ψ
...
module Categories.APROP.Hypergraph.Soundness.Discharge.IsoTransport
...
open import Categories.APROP.Hypergraph.Soundness.Discharge.IsoInvarianceWiring sig
  using (module PerHG)
...
open import Categories.APROP.Hypergraph.Soundness.Discharge.EdgeStepNaturality sig
