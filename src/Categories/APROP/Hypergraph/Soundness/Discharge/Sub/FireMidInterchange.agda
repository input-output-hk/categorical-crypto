...
module Categories.APROP.Hypergraph.Soundness.Discharge.Sub.FireMidInterchange
  (sig : APROPSignature)
...
import Categories.APROP.Hypergraph.Soundness.Discharge.Sub.BlockNFNf2 sig _≟X_ as Nf2
...
import Categories.APROP.Hypergraph.Soundness.Discharge.Sub.StackEquivariance sig as SE
