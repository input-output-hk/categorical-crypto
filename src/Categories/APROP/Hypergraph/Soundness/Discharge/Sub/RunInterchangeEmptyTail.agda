...
module Categories.APROP.Hypergraph.Soundness.Discharge.Sub.RunInterchangeEmptyTail
  (sig : APROPSignature)
...
import Categories.APROP.Hypergraph.Soundness.Discharge.Sub.FireMidInterchange sig _≟X_ as FMI
