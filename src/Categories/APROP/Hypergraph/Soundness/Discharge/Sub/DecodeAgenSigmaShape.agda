...
module Categories.APROP.Hypergraph.Soundness.Discharge.Sub.DecodeAgenSigmaShape
  (sig : APROPSignature)
...
-- …` for EVERY object `A`.
import Categories.APROP.Hypergraph.Soundness.Discharge.BridgeAlphaFormCompound sig as BAFC
