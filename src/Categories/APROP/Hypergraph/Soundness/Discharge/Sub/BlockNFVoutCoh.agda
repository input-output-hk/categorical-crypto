...
module Categories.APROP.Hypergraph.Soundness.Discharge.Sub.BlockNFVoutCoh
  (d : FreeMonoidalData)
...
import Categories.APROP.Hypergraph.Soundness.Discharge.Sub.BlockNFBraid d _≟X_
  as BlockNFBraid
