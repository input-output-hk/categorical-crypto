...
-- `Strict/Braid.agda` + `Strict/DecodeSigmaS.agda` (`σ-hexˢʳ`) and is discharged
...
module Categories.APROP.Hypergraph.Soundness.Strict.DecodeTensorS
  (sig : APROPSignature)
