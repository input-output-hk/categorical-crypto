...
--     ps qs` via `StackEquivS.process-edges-equivariantˢ`.
--
...
module Categories.APROP.Hypergraph.Soundness.Strict.RunInterchangeTailS
  (sig : APROPSignature)
...
import Categories.APROP.Hypergraph.Soundness.Strict.SwapCore sig _≟X_ as SC
