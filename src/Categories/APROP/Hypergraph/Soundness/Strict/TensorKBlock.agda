...
-- as a top-level submodule.  TensorKBlockFinal stays separate (TensorBraidS cycle).
--------------------------------------------------------------------------------
...
import Categories.APROP.Hypergraph.Soundness.Strict.Decoder sig _≟X_ as Dec
...
------------------------------------------------------------------------
open import Categories.APROP.Hypergraph.FromAPROP sig hiding (FlatGen)
