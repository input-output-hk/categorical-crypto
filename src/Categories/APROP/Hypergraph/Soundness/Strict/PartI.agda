...
import Categories.APROP.Hypergraph.Soundness.Strict.DecodeShapes   sig _≟X_ as DSh
import Categories.APROP.Hypergraph.Soundness.Strict.DecodeSigmaS   sig _≟X_ as DSig
import Categories.APROP.Hypergraph.Soundness.Strict.DecodeComposeS3 sig _≟X_ as DComp
...
module _
  ...
  -- the Agen base case is now CONCRETE (DecodeGenS, fully proven)
