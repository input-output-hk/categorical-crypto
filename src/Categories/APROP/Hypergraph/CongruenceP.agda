...
module _
    ...
    (bdy₁ : codL G₁ ≡ domL K₁) (bdy₂ : codL G₂ ≡ domL K₂)
    (iG : G₁ ≅ᴴ G₂) (iK : K₁ ≅ᴴ K₂)
  ...
  --
  -- `dom-P : (hComposeP G₂ K₂ bdy₂).dom ≡ map φ-P (hComposeP G₁ K₁ bdy₁).dom`
  -- reduces to `G₂.dom ≡ map IG.φ G₁.dom` after the inject+ commutation.

  private
    module hCP₁ = hComposeP-impl G₁ K₁ bdy₁
    module hCP₂ = hComposeP-impl G₂ K₂ bdy₂

  dom-P : Hypergraph.dom (hComposeP G₂ K₂ bdy₂)
        ≡ map φ-P (Hypergraph.dom (hComposeP G₁ K₁ bdy₁))
  ...
  cod-P : Hypergraph.cod (hComposeP G₂ K₂ bdy₂)
        ≡ map φ-P (Hypergraph.cod (hComposeP G₁ K₁ bdy₁))
  ...
  hComposeP-resp-≅ᴴ : hComposeP G₁ K₁ bdy₁ ≅ᴴ hComposeP G₂ K₂ bdy₂
