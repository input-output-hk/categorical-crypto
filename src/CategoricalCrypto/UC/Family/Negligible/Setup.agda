...
--
-- `UC.Family.ucSetup^ω` is `Famᴹ` at `Observation^ω`, whose comparison has
...
-- `_≈ℰᴺ_` and not a parallel spelling; `rel-agree` is that check.
...
private module N = Negᴹ M obsᴹ qapx bud Ix κ κ-cofinal
