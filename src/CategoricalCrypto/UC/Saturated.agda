...
-- side's obligation (review §1), discharged for the compiled watch by
-- `UC.Machine.Monitor.Agree.agree`; a corrected audit premise arrives here as
-- the `bad` a `SaturatedBounded` is stated at.
