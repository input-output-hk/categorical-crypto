...
opaque
  ...
  head₁ {D} {E} {E₁} {E₂} =
    ≅ᴹ-trans {M₂ = Xfwd (λ a → (app (absorb-regroupσᵢ {D} {E₂} {E₁} {E})) ((app (∘ᴷ-fwdᵢ {D ⊗₀ E₂} {E} {E₁})) a)) (λ o → (app (∘ᴷ-fwdₒ {D ⊗₀ E₂} {E} {E₁})) ((app (absorb-regroupσₒ {D} {E₂} {E₁} {E})) o))} L (≅ᴹ-trans {M₂ = Xfwd (λ a → (app (∘ᴷ-fwdᵢ {D} {E} {E₁ ⊗₀ E₂})) (⊗mapᵢ {(D ⊗₀ E₂) ⊗₀ E₁} {D ⊗₀ (E₁ ⊗₀ E₂)} {E} {E} (app (∘ᴷ-fwdᵢ {D} {E₁} {E₂})) (λ (x : inType E) → x) a)) (λ o → ⊗mapₒ {(D ⊗₀ E₂) ⊗₀ E₁} {D ⊗₀ (E₁ ⊗₀ E₂)} {E} {E} (app (∘ᴷ-fwdₒ {D} {E₁} {E₂})) (λ (x : outType E) → x) ((app (∘ᴷ-fwdₒ {D} {E} {E₁ ⊗₀ E₂})) o))} P (≅ᴹ-sym R))
    where
    ...
    r₁ : (∘ᴷ-fwd {D} {E₁} {E₂} ⊗₁ CC.id {E}) ≅ᴹ Xfwd (⊗mapᵢ {(D ⊗₀ E₂) ⊗₀ E₁} {D ⊗₀ (E₁ ⊗₀ E₂)} {E} {E} (app (∘ᴷ-fwdᵢ {D} {E₁} {E₂})) (λ (x : inType E) → x)) (⊗mapₒ {(D ⊗₀ E₂) ⊗₀ E₁} {D ⊗₀ (E₁ ⊗₀ E₂)} {E} {E} (app (∘ᴷ-fwdₒ {D} {E₁} {E₂})) (λ (x : outType E) → x))
    r₁ = ≅ᴹ-trans (⊗₁-resp-≅ᴹ (tfm'-is-Xfwd (∘ᴷ-fwdᵢ {D} {E₁} {E₂}) (∘ᴷ-fwdₒ {D} {E₁} {E₂}))
                              id-is-Xfwd)
                  ⊗₁-Xfwd

    R : (∘ᴷ-fwd {D} {E} {E₁ ⊗₀ E₂} CC.∘ (∘ᴷ-fwd {D} {E₁} {E₂} ⊗₁ CC.id {E})) ≅ᴹ Xfwd (λ a → (app (∘ᴷ-fwdᵢ {D} {E} {E₁ ⊗₀ E₂})) (⊗mapᵢ {(D ⊗₀ E₂) ⊗₀ E₁} {D ⊗₀ (E₁ ⊗₀ E₂)} {E} {E} (app (∘ᴷ-fwdᵢ {D} {E₁} {E₂})) (λ (x : inType E) → x) a)) (λ o → ⊗mapₒ {(D ⊗₀ E₂) ⊗₀ E₁} {D ⊗₀ (E₁ ⊗₀ E₂)} {E} {E} (app (∘ᴷ-fwdₒ {D} {E₁} {E₂})) (λ (x : outType E) → x) ((app (∘ᴷ-fwdₒ {D} {E} {E₁ ⊗₀ E₂})) o))
    R = ≅ᴹ-trans (∘-resp-≅ᴹ (tfm'-is-Xfwd (∘ᴷ-fwdᵢ {D} {E} {E₁ ⊗₀ E₂}) (∘ᴷ-fwdₒ {D} {E} {E₁ ⊗₀ E₂}))
                            r₁)
                 ∘-Xfwd

    P : Xfwd (λ a → (app (absorb-regroupσᵢ {D} {E₂} {E₁} {E})) ((app (∘ᴷ-fwdᵢ {D ⊗₀ E₂} {E} {E₁})) a)) (λ o → (app (∘ᴷ-fwdₒ {D ⊗₀ E₂} {E} {E₁})) ((app (absorb-regroupσₒ {D} {E₂} {E₁} {E})) o)) ≅ᴹ Xfwd (λ a → (app (∘ᴷ-fwdᵢ {D} {E} {E₁ ⊗₀ E₂})) (⊗mapᵢ {(D ⊗₀ E₂) ⊗₀ E₁} {D ⊗₀ (E₁ ⊗₀ E₂)} {E} {E} (app (∘ᴷ-fwdᵢ {D} {E₁} {E₂})) (λ (x : inType E) → x) a)) (λ o → ⊗mapₒ {(D ⊗₀ E₂) ⊗₀ E₁} {D ⊗₀ (E₁ ⊗₀ E₂)} {E} {E} (app (∘ᴷ-fwdₒ {D} {E₁} {E₂})) (λ (x : outType E) → x) ((app (∘ᴷ-fwdₒ {D} {E} {E₁ ⊗₀ E₂})) o))
  ...
  head₂ {C₁} {E₁ᵃ} {E₁ᵇ} {C₂} {E₂ᵃ} {E₂ᵇ} =
    ≅ᴹ-trans {M₂ = Xfwd (λ a → ⊗mapᵢ {C₁ ⊗₀ C₂} {C₁ ⊗₀ C₂} {(E₁ᵃ ⊗₀ E₂ᵃ) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {(E₁ᵃ ⊗₀ E₁ᵇ) ⊗₀ (E₂ᵃ ⊗₀ E₂ᵇ)} (λ (x : inType (C₁ ⊗₀ C₂)) → x) (app (mid4σᵢ {E₁ᵃ} {E₂ᵃ} {E₁ᵇ} {E₂ᵇ})) ((app (∘ᴷ-fwdᵢ {C₁ ⊗₀ C₂} {E₁ᵃ ⊗₀ E₂ᵃ} {E₁ᵇ ⊗₀ E₂ᵇ})) (⊗mapᵢ {(C₁ ⊗₀ E₁ᵇ) ⊗₀ (C₂ ⊗₀ E₂ᵇ)} {(C₁ ⊗₀ C₂) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {E₁ᵃ ⊗₀ E₂ᵃ} {E₁ᵃ ⊗₀ E₂ᵃ} (app (⊗ᴷ-fwdᵢ {C₁} {E₁ᵇ} {C₂} {E₂ᵇ})) (λ (x : inType (E₁ᵃ ⊗₀ E₂ᵃ)) → x) ((app (⊗ᴷ-fwdᵢ {C₁ ⊗₀ E₁ᵇ} {E₁ᵃ} {C₂ ⊗₀ E₂ᵇ} {E₂ᵃ})) a)))) (λ o → (app (⊗ᴷ-fwdₒ {C₁ ⊗₀ E₁ᵇ} {E₁ᵃ} {C₂ ⊗₀ E₂ᵇ} {E₂ᵃ})) (⊗mapₒ {(C₁ ⊗₀ E₁ᵇ) ⊗₀ (C₂ ⊗₀ E₂ᵇ)} {(C₁ ⊗₀ C₂) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {E₁ᵃ ⊗₀ E₂ᵃ} {E₁ᵃ ⊗₀ E₂ᵃ} (app (⊗ᴷ-fwdₒ {C₁} {E₁ᵇ} {C₂} {E₂ᵇ})) (λ (x : outType (E₁ᵃ ⊗₀ E₂ᵃ)) → x) ((app (∘ᴷ-fwdₒ {C₁ ⊗₀ C₂} {E₁ᵃ ⊗₀ E₂ᵃ} {E₁ᵇ ⊗₀ E₂ᵇ})) (⊗mapₒ {C₁ ⊗₀ C₂} {C₁ ⊗₀ C₂} {(E₁ᵃ ⊗₀ E₂ᵃ) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {(E₁ᵃ ⊗₀ E₁ᵇ) ⊗₀ (E₂ᵃ ⊗₀ E₂ᵇ)} (λ (x : outType (C₁ ⊗₀ C₂)) → x) (app (mid4σₒ {E₁ᵃ} {E₂ᵃ} {E₁ᵇ} {E₂ᵇ})) o))))} L (≅ᴹ-trans {M₂ = Xfwd (λ a → (app (⊗ᴷ-fwdᵢ {C₁} {E₁ᵃ ⊗₀ E₁ᵇ} {C₂} {E₂ᵃ ⊗₀ E₂ᵇ})) (⊗mapᵢ {(C₁ ⊗₀ E₁ᵇ) ⊗₀ E₁ᵃ} {C₁ ⊗₀ (E₁ᵃ ⊗₀ E₁ᵇ)} {(C₂ ⊗₀ E₂ᵇ) ⊗₀ E₂ᵃ} {C₂ ⊗₀ (E₂ᵃ ⊗₀ E₂ᵇ)} (app (∘ᴷ-fwdᵢ {C₁} {E₁ᵃ} {E₁ᵇ})) (app (∘ᴷ-fwdᵢ {C₂} {E₂ᵃ} {E₂ᵇ})) a)) (λ o → ⊗mapₒ {(C₁ ⊗₀ E₁ᵇ) ⊗₀ E₁ᵃ} {C₁ ⊗₀ (E₁ᵃ ⊗₀ E₁ᵇ)} {(C₂ ⊗₀ E₂ᵇ) ⊗₀ E₂ᵃ} {C₂ ⊗₀ (E₂ᵃ ⊗₀ E₂ᵇ)} (app (∘ᴷ-fwdₒ {C₁} {E₁ᵃ} {E₁ᵇ})) (app (∘ᴷ-fwdₒ {C₂} {E₂ᵃ} {E₂ᵇ})) ((app (⊗ᴷ-fwdₒ {C₁} {E₁ᵃ ⊗₀ E₁ᵇ} {C₂} {E₂ᵃ ⊗₀ E₂ᵇ})) o))} P (≅ᴹ-sym R))
    where
    ...
    l₀ : (CC.id {C₁ ⊗₀ C₂} ⊗₁ mid4 {E₁ᵃ} {E₂ᵃ} {E₁ᵇ} {E₂ᵇ}) ≅ᴹ Xfwd (⊗mapᵢ {C₁ ⊗₀ C₂} {C₁ ⊗₀ C₂} {(E₁ᵃ ⊗₀ E₂ᵃ) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {(E₁ᵃ ⊗₀ E₁ᵇ) ⊗₀ (E₂ᵃ ⊗₀ E₂ᵇ)} (λ (x : inType (C₁ ⊗₀ C₂)) → x) (app (mid4σᵢ {E₁ᵃ} {E₂ᵃ} {E₁ᵇ} {E₂ᵇ}))) (⊗mapₒ {C₁ ⊗₀ C₂} {C₁ ⊗₀ C₂} {(E₁ᵃ ⊗₀ E₂ᵃ) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {(E₁ᵃ ⊗₀ E₁ᵇ) ⊗₀ (E₂ᵃ ⊗₀ E₂ᵇ)} (λ (x : outType (C₁ ⊗₀ C₂)) → x) (app (mid4σₒ {E₁ᵃ} {E₂ᵃ} {E₁ᵇ} {E₂ᵇ})))
    l₀ = ≅ᴹ-trans (⊗₁-resp-≅ᴹ id-is-Xfwd (tfm'-is-Xfwd (mid4σᵢ {E₁ᵃ} {E₂ᵃ} {E₁ᵇ} {E₂ᵇ}) (mid4σₒ {E₁ᵃ} {E₂ᵃ} {E₁ᵇ} {E₂ᵇ}))) ⊗₁-Xfwd

    l₁ : (⊗ᴷ-fwd {C₁} {E₁ᵇ} {C₂} {E₂ᵇ} ⊗₁ CC.id {E₁ᵃ ⊗₀ E₂ᵃ}) ≅ᴹ Xfwd (⊗mapᵢ {(C₁ ⊗₀ E₁ᵇ) ⊗₀ (C₂ ⊗₀ E₂ᵇ)} {(C₁ ⊗₀ C₂) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {E₁ᵃ ⊗₀ E₂ᵃ} {E₁ᵃ ⊗₀ E₂ᵃ} (app (⊗ᴷ-fwdᵢ {C₁} {E₁ᵇ} {C₂} {E₂ᵇ})) (λ (x : inType (E₁ᵃ ⊗₀ E₂ᵃ)) → x)) (⊗mapₒ {(C₁ ⊗₀ E₁ᵇ) ⊗₀ (C₂ ⊗₀ E₂ᵇ)} {(C₁ ⊗₀ C₂) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {E₁ᵃ ⊗₀ E₂ᵃ} {E₁ᵃ ⊗₀ E₂ᵃ} (app (⊗ᴷ-fwdₒ {C₁} {E₁ᵇ} {C₂} {E₂ᵇ})) (λ (x : outType (E₁ᵃ ⊗₀ E₂ᵃ)) → x))
    l₁ = ≅ᴹ-trans (⊗₁-resp-≅ᴹ (tfm'-is-Xfwd (⊗ᴷ-fwdᵢ {C₁} {E₁ᵇ} {C₂} {E₂ᵇ}) (⊗ᴷ-fwdₒ {C₁} {E₁ᵇ} {C₂} {E₂ᵇ})) id-is-Xfwd) ⊗₁-Xfwd

    l₂ : ((⊗ᴷ-fwd {C₁} {E₁ᵇ} {C₂} {E₂ᵇ} ⊗₁ CC.id {E₁ᵃ ⊗₀ E₂ᵃ}) CC.∘ ⊗ᴷ-fwd {C₁ ⊗₀ E₁ᵇ} {E₁ᵃ} {C₂ ⊗₀ E₂ᵇ} {E₂ᵃ}) ≅ᴹ Xfwd (λ a → ⊗mapᵢ {(C₁ ⊗₀ E₁ᵇ) ⊗₀ (C₂ ⊗₀ E₂ᵇ)} {(C₁ ⊗₀ C₂) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {E₁ᵃ ⊗₀ E₂ᵃ} {E₁ᵃ ⊗₀ E₂ᵃ} (app (⊗ᴷ-fwdᵢ {C₁} {E₁ᵇ} {C₂} {E₂ᵇ})) (λ (x : inType (E₁ᵃ ⊗₀ E₂ᵃ)) → x) ((app (⊗ᴷ-fwdᵢ {C₁ ⊗₀ E₁ᵇ} {E₁ᵃ} {C₂ ⊗₀ E₂ᵇ} {E₂ᵃ})) a)) (λ o → (app (⊗ᴷ-fwdₒ {C₁ ⊗₀ E₁ᵇ} {E₁ᵃ} {C₂ ⊗₀ E₂ᵇ} {E₂ᵃ})) (⊗mapₒ {(C₁ ⊗₀ E₁ᵇ) ⊗₀ (C₂ ⊗₀ E₂ᵇ)} {(C₁ ⊗₀ C₂) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {E₁ᵃ ⊗₀ E₂ᵃ} {E₁ᵃ ⊗₀ E₂ᵃ} (app (⊗ᴷ-fwdₒ {C₁} {E₁ᵇ} {C₂} {E₂ᵇ})) (λ (x : outType (E₁ᵃ ⊗₀ E₂ᵃ)) → x) o))
    ...
    P : Xfwd (λ a → ⊗mapᵢ {C₁ ⊗₀ C₂} {C₁ ⊗₀ C₂} {(E₁ᵃ ⊗₀ E₂ᵃ) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {(E₁ᵃ ⊗₀ E₁ᵇ) ⊗₀ (E₂ᵃ ⊗₀ E₂ᵇ)} (λ (x : inType (C₁ ⊗₀ C₂)) → x) (app (mid4σᵢ {E₁ᵃ} {E₂ᵃ} {E₁ᵇ} {E₂ᵇ})) ((app (∘ᴷ-fwdᵢ {C₁ ⊗₀ C₂} {E₁ᵃ ⊗₀ E₂ᵃ} {E₁ᵇ ⊗₀ E₂ᵇ})) (⊗mapᵢ {(C₁ ⊗₀ E₁ᵇ) ⊗₀ (C₂ ⊗₀ E₂ᵇ)} {(C₁ ⊗₀ C₂) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {E₁ᵃ ⊗₀ E₂ᵃ} {E₁ᵃ ⊗₀ E₂ᵃ} (app (⊗ᴷ-fwdᵢ {C₁} {E₁ᵇ} {C₂} {E₂ᵇ})) (λ (x : inType (E₁ᵃ ⊗₀ E₂ᵃ)) → x) ((app (⊗ᴷ-fwdᵢ {C₁ ⊗₀ E₁ᵇ} {E₁ᵃ} {C₂ ⊗₀ E₂ᵇ} {E₂ᵃ})) a)))) (λ o → (app (⊗ᴷ-fwdₒ {C₁ ⊗₀ E₁ᵇ} {E₁ᵃ} {C₂ ⊗₀ E₂ᵇ} {E₂ᵃ})) (⊗mapₒ {(C₁ ⊗₀ E₁ᵇ) ⊗₀ (C₂ ⊗₀ E₂ᵇ)} {(C₁ ⊗₀ C₂) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {E₁ᵃ ⊗₀ E₂ᵃ} {E₁ᵃ ⊗₀ E₂ᵃ} (app (⊗ᴷ-fwdₒ {C₁} {E₁ᵇ} {C₂} {E₂ᵇ})) (λ (x : outType (E₁ᵃ ⊗₀ E₂ᵃ)) → x) ((app (∘ᴷ-fwdₒ {C₁ ⊗₀ C₂} {E₁ᵃ ⊗₀ E₂ᵃ} {E₁ᵇ ⊗₀ E₂ᵇ})) (⊗mapₒ {C₁ ⊗₀ C₂} {C₁ ⊗₀ C₂} {(E₁ᵃ ⊗₀ E₂ᵃ) ⊗₀ (E₁ᵇ ⊗₀ E₂ᵇ)} {(E₁ᵃ ⊗₀ E₁ᵇ) ⊗₀ (E₂ᵃ ⊗₀ E₂ᵇ)} (λ (x : outType (C₁ ⊗₀ C₂)) → x) (app (mid4σₒ {E₁ᵃ} {E₂ᵃ} {E₁ᵇ} {E₂ᵇ})) o)))) ≅ᴹ Xfwd (λ a → (app (⊗ᴷ-fwdᵢ {C₁} {E₁ᵃ ⊗₀ E₁ᵇ} {C₂} {E₂ᵃ ⊗₀ E₂ᵇ})) (⊗mapᵢ {(C₁ ⊗₀ E₁ᵇ) ⊗₀ E₁ᵃ} {C₁ ⊗₀ (E₁ᵃ ⊗₀ E₁ᵇ)} {(C₂ ⊗₀ E₂ᵇ) ⊗₀ E₂ᵃ} {C₂ ⊗₀ (E₂ᵃ ⊗₀ E₂ᵇ)} (app (∘ᴷ-fwdᵢ {C₁} {E₁ᵃ} {E₁ᵇ})) (app (∘ᴷ-fwdᵢ {C₂} {E₂ᵃ} {E₂ᵇ})) a)) (λ o → ⊗mapₒ {(C₁ ⊗₀ E₁ᵇ) ⊗₀ E₁ᵃ} {C₁ ⊗₀ (E₁ᵃ ⊗₀ E₁ᵇ)} {(C₂ ⊗₀ E₂ᵇ) ⊗₀ E₂ᵃ} {C₂ ⊗₀ (E₂ᵃ ⊗₀ E₂ᵇ)} (app (∘ᴷ-fwdₒ {C₁} {E₁ᵃ} {E₁ᵇ})) (app (∘ᴷ-fwdₒ {C₂} {E₂ᵃ} {E₂ᵇ})) ((app (⊗ᴷ-fwdₒ {C₁} {E₁ᵃ ⊗₀ E₁ᵇ} {C₂} {E₂ᵃ ⊗₀ E₂ᵇ})) o))
    P = Xfwd-≅ᴹ (λ { (inj₁ (inj₁ (inj₁ _))) → refl
                   ; (inj₁ (inj₁ (inj₂ _))) → refl
                   ; (inj₁ (inj₂ _))        → refl
                   ; (inj₂ (inj₁ (inj₁ _))) → refl
