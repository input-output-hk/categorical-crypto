...
--
-- `CategoricalCrypto.Machine.Forwarder` shows that forwarders are closed under the machine
-- builders, and `CategoricalCrypto.Machine.Reindex` pushes every channel reshuffle
